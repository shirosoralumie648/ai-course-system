...
本讲主题是“AI 辅助写作”。它服务于课程 A 的核心目标：让非计算机专业学生把 AI 放入真实专业任务，而不是背诵 Prompt 模板或直接复制 AI 输出。
...
- 本周核心问题：如何让 AI 参与写作过程，而不是替代作者判断？
- 关键概念：写作目标, 受众, 风格控制, 人工修订, 引用, 学术诚信。
- 过程证据：Prompt、AI 输出、人工修订、风险说明。

## 4. 教学难点

- 学生直接提交未经核查和修订的 AI 文本。
...
| 10-30 分钟 | 概念讲解 | 讲解 写作目标, 受众, 风格控制 | 概念笔记 |
| 30-50 分钟 | 案例演示 | 对比坏例子和好例子 | 观察记录 |
| 50-80 分钟 | 学生实操 | 对一段 AI 生成文本进行人工修订，标注事实、结构、风格和引用问题。 | 课堂任务初稿 |
...
对一段 AI 生成文本进行人工修订，标注事实、结构、风格和引用问题。
...
提交写作前后版本、AI 使用记录和人工修订说明。

提交物：写作 Prompt, AI 初稿, 人工修订稿, 修订说明。
