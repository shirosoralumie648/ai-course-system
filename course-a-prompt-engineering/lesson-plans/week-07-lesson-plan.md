# 第 7 周教案：AI 辅助创意与展示、个人 AI 工作流

## 1. 本讲定位

本讲主题是“AI 辅助创意与展示、个人 AI 工作流”。它服务于课程 A 的核心目标：让非计算机专业学生把 AI 放入真实专业任务，而不是背诵 Prompt 模板或直接复制 AI 输出。
...
- 本周核心问题：如何把零散 AI 使用变成稳定的个人工作流？
- 关键概念：创意发散, 创意筛选, 展示结构, 流程复用, 个人工作流。
- 过程证据：Prompt、AI 输出、人工修订、风险说明。

## 4. 教学难点

- 学生把工作流画成工具清单，没有任务、判断和复盘。
...
| 10-30 分钟 | 概念讲解 | 讲解 创意发散, 创意筛选, 展示结构 | 概念笔记 |
| 30-50 分钟 | 案例演示 | 对比坏例子和好例子 | 观察记录 |
| 50-80 分钟 | 学生实操 | 绘制个人 AI 工作流图，标出 AI 执行、人类判断和风险检查点。 | 课堂任务初稿 |
...
绘制个人 AI 工作流图，标出 AI 执行、人类判断和风险检查点。
...
提交期末项目选题和个人 AI 工作流草案。

提交物：创意清单, 展示结构, 个人工作流图, 期末选题。
