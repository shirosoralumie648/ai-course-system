...
本讲主题是“任务拆解与上下文表达”。它服务于课程 A 的核心目标：让非计算机专业学生把 AI 放入真实专业任务，而不是背诵 Prompt 模板或直接复制 AI 输出。
...
- 本周核心问题：如何把复杂专业任务拆成 AI 可以辅助执行的步骤？
- 关键概念：任务拆解, 上下文包, 材料选择, 约束条件, 样例, 输出格式。
- 过程证据：Prompt、AI 输出、人工修订、风险说明。

## 4. 教学难点

- 学生把大任务一次性交给 AI，缺少分步验收。
...
| 10-30 分钟 | 概念讲解 | 讲解 任务拆解, 上下文包, 材料选择 | 概念笔记 |
| 30-50 分钟 | 案例演示 | 对比坏例子和好例子 | 观察记录 |
| 50-80 分钟 | 学生实操 | 为一个专业任务写上下文包，包含目标、材料、限制、样例和输出格式。 | 课堂任务初稿 |
...
为一个专业任务写上下文包，包含目标、材料、限制、样例和输出格式。
...
提交任务拆解表，说明每一步 AI 做什么、人做什么、如何验收。

提交物：任务拆解表, 上下文包, 人工验收标准。
