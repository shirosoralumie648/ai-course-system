# 第 8 周教案：专业场景项目、风险、伦理、版权与学术诚信

## 1. 本讲定位

本讲主题是“专业场景项目、风险、伦理、版权与学术诚信”。它服务于课程 A 的核心目标：让非计算机专业学生把 AI 放入真实专业任务，而不是背诵 Prompt 模板或直接复制 AI 输出。
...
- 本周核心问题：如何展示一个可信、合规、可复盘的专业 AI 工作流？
- 关键概念：专业场景, 隐私, 版权, 偏见, 学术诚信, 复盘。
- 过程证据：Prompt、AI 输出、人工修订、风险说明。

## 4. 教学难点

- 学生只展示 AI 生成结果，不说明人工判断、来源核查和风险控制。
...
| 10-30 分钟 | 概念讲解 | 讲解 专业场景, 隐私, 版权 | 概念笔记 |
| 30-50 分钟 | 案例演示 | 对比坏例子和好例子 | 观察记录 |
| 50-80 分钟 | 学生实操 | 期末项目展示和互评，重点检查 AI 参与环节、人工修订和风险控制。 | 课堂任务初稿 |
...
期末项目展示和互评，重点检查 AI 参与环节、人工修订和风险控制。
...
提交最终项目、AI 使用记录、风险说明和课程复盘。

提交物：期末项目, 展示材料, 风险说明, 互评表, 课程复盘。
