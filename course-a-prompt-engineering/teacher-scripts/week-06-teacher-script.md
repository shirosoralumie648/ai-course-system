...
各位同学，今天我们进入第 6 周，主题是“AI 辅助数据分析”。本节课要解决的问题是：如何用 AI 辅助数据分析，同时避免错误计算和过度解读？
...
本周的关键概念包括：数据字段, 指标解释, 数据清洗, 图表解读, 错误检查, 过度解读。
...
现在请大家完成课堂任务：分析一个小型公开数据表，生成指标解释、图表建议和风险清单。
...
本周作业是：提交分析报告、AI 交互记录、人工核查说明和风险说明。

提交时请保留：数据说明, 分析报告, 核查记录, 风险说明。
