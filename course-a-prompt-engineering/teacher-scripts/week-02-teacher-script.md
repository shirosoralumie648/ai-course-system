# 第 2 周教师讲稿：Prompt 基本结构

## 0-10 分钟：开场与导入

各位同学，今天我们进入第 2 周，主题是“Prompt 基本结构”。本节课要解决的问题是：怎样把模糊请求改写成可执行、可评价的 Prompt？
...
本周的关键概念包括：角色, 任务, 背景, 限制, 输出格式, 评价标准。
...
现在请大家完成课堂任务：把一个模糊 Prompt 改写成面向专业任务的结构化 Prompt。
...
本周作业是：提交 3 个专业任务 Prompt，并为每个 Prompt 写出使用场景和评价标准。

提交时请保留：坏 Prompt 分析, 结构化 Prompt, Prompt 设计说明。
