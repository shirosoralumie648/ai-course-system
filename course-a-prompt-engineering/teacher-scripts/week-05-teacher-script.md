...
各位同学，今天我们进入第 5 周，主题是“AI 辅助写作”。本节课要解决的问题是：如何让 AI 参与写作过程，而不是替代作者判断？
...
本周的关键概念包括：写作目标, 受众, 风格控制, 人工修订, 引用, 学术诚信。
...
现在请大家完成课堂任务：对一段 AI 生成文本进行人工修订，标注事实、结构、风格和引用问题。
...
本周作业是：提交写作前后版本、AI 使用记录和人工修订说明。

提交时请保留：写作 Prompt, AI 初稿, 人工修订稿, 修订说明。
