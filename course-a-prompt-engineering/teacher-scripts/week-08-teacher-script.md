# 第 8 周教师讲稿：专业场景项目、风险、伦理、版权与学术诚信

## 0-10 分钟：开场与导入

各位同学，今天我们进入第 8 周，主题是“专业场景项目、风险、伦理、版权与学术诚信”。本节课要解决的问题是：如何展示一个可信、合规、可复盘的专业 AI 工作流？
...
本周的关键概念包括：专业场景, 隐私, 版权, 偏见, 学术诚信, 复盘。
...
现在请大家完成课堂任务：期末项目展示和互评，重点检查 AI 参与环节、人工修订和风险控制。
...
本周作业是：提交最终项目、AI 使用记录、风险说明和课程复盘。

提交时请保留：期末项目, 展示材料, 风险说明, 互评表, 课程复盘。
