# 第 3 周教师讲稿：任务拆解与上下文表达

## 0-10 分钟：开场与导入

各位同学，今天我们进入第 3 周，主题是“任务拆解与上下文表达”。本节课要解决的问题是：如何把复杂专业任务拆成 AI 可以辅助执行的步骤？
...
本周的关键概念包括：任务拆解, 上下文包, 材料选择, 约束条件, 样例, 输出格式。
...
现在请大家完成课堂任务：为一个专业任务写上下文包，包含目标、材料、限制、样例和输出格式。
...
本周作业是：提交任务拆解表，说明每一步 AI 做什么、人做什么、如何验收。

提交时请保留：任务拆解表, 上下文包, 人工验收标准。
