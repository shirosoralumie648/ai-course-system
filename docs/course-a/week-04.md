...
<ChapterIntroduction duration="约 3 小时" output="3 个经过验证的产品概念，以及一套完整的需求分析方法" prerequisite="完成 Week 01-02 的 Claude Code 基础练习" :tags="['需求挖掘', '产品思维', '用户分析', '商业模式', '痛点分析']">
...
<StepBar :active="0" :items="[
  { title: '① 理解真需求', description: '什么样的需求用户愿意买单' },
  { title: '② 横向切分人群', description: '找到最痛的那个群体' },
  { title: '③ 纵向深挖场景', description: '理解完整的用户旅程' }
]" />
...
![用户旅程地图：从想法到真实付费意愿](./week-04-images/user-journey-map.png)

*纵向深挖不是继续夸功能，而是沿着真实场景找到触发、阻力、代价和硬验证信号。*
