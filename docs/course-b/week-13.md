...
![微信云开发架构](week-13-images/cloud-dev-architecture.png)

*小程序端负责交互，敏感业务能力通过云函数连接云数据库、云存储、内容审核和微信支付。*
...
![支付签名与回调验签流程](week-13-images/payment-security-flow.png)

*支付链路必须以服务端订单和回调验签为准，不能只相信前端页面显示。*
